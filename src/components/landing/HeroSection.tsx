      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-center">
          ...
          >
            ...
            <div className="inline-flex items-center gap-2.5 px-3.5 py-1.5 rounded-full bg-cyan-950/40 border border-cyber-primary/40 text-cyber-primary font-mono text-xs shadow-cyber-glow-sm">
              <span className="w-2 h-2 rounded-full bg-cyber-primary animate-ping" />
              <Radio className="w-3.5 h-3.5" />
              <span>PRESENTED BY SCRS // SOFT COMPUTING RESEARCH SOCIETY</span>
            </div>
            ...
            <div className="space-y-2">
              ...
              <h2 className="text-lg sm:text-2xl font-bold text-cyber-text-muted font-mono tracking-tight">
                Security Operations Centre Analyst Bootcamp
              </h2>
            </div>

            {/* Tagline */}
            <div className="flex items-center justify-center lg:justify-start gap-3 text-sm sm:text-base font-mono font-extrabold tracking-widest text-cyber-primary">
            ...
            {/* Concise Description */}
            <p className="text-sm sm:text-base text-cyber-text-muted max-w-2xl leading-relaxed">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-2.5 pt-1">
              {metadataBadges.map((badge, idx) => {
                ...
                return (
                  <div
                    key={idx}
                    className="flex items-center justify-center lg:justify-start gap-2 p-2.5 rounded-xl bg-cyber-surface/70 border border-cyber-border/80 text-xs font-mono font-bold text-cyber-text hover:border-cyber-primary/40 transition-colors"
                  >
